package com.debi.java.builder.entty;
...
import com.debi.java.builder.utility.Utility;
...
public class BuilderEntity {
	...
	public void setOverview(String overview) {
        if (StringUtils.hasText(overview)) {
        	Utility.isTrue(overview.length() <= BuilderConstant.MAX_LENGTH_OVERVIEW,
                    "Overview cannot be longer than %d characters",
                    BuilderConstant.MAX_LENGTH_OVERVIEW
            );
        }
